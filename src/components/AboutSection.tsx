export function AboutSection() {
    return (
      <section className="bg-gradient-to-b from-[#7CC6FF] to-[#5BB5FF] py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-white text-lg leading-relaxed">
            ...
            organizaciones. A través de cursos inmersivos y experienciales, ayudamos a nuestros clientes a desarrollar
            habilidades clave como liderazgo, pensamiento estratégico, gestión de equipos de alto rendimiento y
